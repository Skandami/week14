...
const myInformation = ["Julia", "4", "5", "Taurus"];
...
console.log(countries.push("Italy", "Spain", "France"));
...
let squaredNumbers = numbers.map(function(elem) {
	return elem * 2;
});
...
colors.forEach(function(elements) {
...
const bigCities = ['Санкт-Петербург', 'Москва', "Екатеринбург"];

console.log(...bigCities, ...russianCities);
...
const filterEvenNumbers = (num) => num % 2 == 0;
const even = numbers.filter(filterEvenNumbers);
console.log(even);
